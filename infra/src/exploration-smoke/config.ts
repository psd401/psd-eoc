...
export const EXPLORATION_SMOKE_ACCOUNT = '338414773271';
export const EXPLORATION_SMOKE_REGION = 'us-west-2';
export const EXPLORATION_SMOKE_STACK_NAME = 'PsdEocExplorationSmoke';

export const EXPLORATION_SMOKE_ENVIRONMENT = 'exploration-smoke';
export const EXPLORATION_SMOKE_DATA_CLASSIFICATION = 'synthetic-only';
