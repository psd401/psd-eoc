...
export class PsdEocStack extends Stack {
  public constructor(scope: Construct, id: string, props: StackProps) {
    ...
    const appImageIdentifier = new CfnParameter(this, 'AppImageIdentifier', {
      allowedPattern:
        '^<aws-account-id>\\.dkr\\.ecr\\.us-west-2\\.amazonaws\\.com\\/[a-z0-9]+(?:[._/-][a-z0-9]+)*@sha256:[0-9a-f]{64}$',
      constraintDescription:
        'Use an immutable image digest from a private ECR repository in account <aws-account-id> and us-west-2.',
      description:
