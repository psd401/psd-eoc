ALTER TYPE "public"."group_source_kind" ADD VALUE 'manual' BEFORE 'synthetic';--> statement-breakpoint
...
ALTER TABLE "group_sources" ADD CONSTRAINT "group_sources_valid_variant" CHECK ((
        ...
        and "group_sources"."email" is null
        and "group_sources"."fixture_key" is null
        and "group_sources"."purpose" = 'building'
        and "group_sources"."facility_id" is not null
      ));