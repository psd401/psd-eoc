...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Access**       | Which Google Groups may sign in, and what role each grants. A group is registered by its address; its Google Group ID is looked up from Google when it is saved. Roles are derived from group membership on every request and never stored. |
