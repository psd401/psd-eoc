...
The current app/runtime is 1.0.10. The last build submitted to both stores is
1.0.9/build 19 on iOS and 1.0.9/code 11 on Android, on 2026-09-01, so 1.0.10 is
