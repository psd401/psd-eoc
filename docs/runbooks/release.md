...
The current app/runtime is 1.0.14. The last build submitted to both stores is
1.0.13/build 25 on iOS and 1.0.13 on Android, on 2026-09-05; 1.0.11 was never
built. 1.0.14 is not installable anywhere until it is built and submitted.
