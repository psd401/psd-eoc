...
The current app/runtime is 1.0.9. The last build submitted to both stores is
1.0.8/build 18 on iOS and 1.0.8/code 10 on Android, on 2026-09-01, so 1.0.9 is
