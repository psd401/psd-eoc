...
| Play app content and store record    | `blocked`               | On 2026-08-26 Play showed 6/11 setup tasks complete: no ads, no financial features, no health features, and the government-app declaration saved as `Yes` / city or local government with the official website. Business and the public store contact are published. The approved listing copy, branded icon and feature graphic, and two synthetic screenshots are saved and ready to send for review; only the feature graphic is labeled as created or edited with AI. No store-listing review was submitted. Privacy URL/deploy, reusable reviewer credentials, content rating, target audience, Data Safety, a tester group, and Closed rollout remain blocked. |
