...
| D-017 | 2026-08-06 | Really high reliability required — this is school safety infrastructure. Not PSD Maps' repair-time-outage model: multi-AZ, always-on database, redundant delivery, monitoring/canaries. Concrete SLOs to be proposed in the plan for PO approval. | PO (unprompted) |
...
| D-024 | 2026-08-06 | Scale: ~100 users initially, hard ceiling 1,200 total staff. Largest-building count immaterial at this scale. Delivery capacity is trivial; latency targets drive design, not throughput. | PO Q1.15 |
...
| D-026 | 2026-08-06 | Hosting: same AWS account as PSD Maps (<aws-account-id>, us-west-2). Separate stack/resources, but shared account. Availability posture still differs from Maps per D-017 (no auto-pause, multi-AZ). | PO Q1.17 |
